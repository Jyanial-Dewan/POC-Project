    ...
    <div className="flex justify-between items-center h-[4rem] w-full bg-white shadow-md fixed px-6">
      <div className="flex items-center gap-4">
        {open ? (
          <button
            ...
            className="text-2xl h-[2rem] w-[2rem] flex justify-center items-center bg-blue-100 rounded-full duration-500 hover:rotate-[360deg]"
          >
            <IoMdClose />
          </button>
        ) : (
      ...
      <div className="flex items-center gap-10">
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "flex gap-2 bg-blue-100 px-4 py-2 rounded-md"
              : "flex gap-2"
          }
        >
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="focus: outline-none">
            <img
              ...
              className="w-[2.5rem] h-[2.5rem] rounded-full object-cover object-center"
            />
          </DropdownMenuTrigger>
          <DropdownMenuContent className="bg-white text-[#0D0D0D] flex flex-col gap-1 w-40 p-2 mt-[0.6rem]">
            ...
            <NavLink
              className={({ isActive }) =>
                isActive
                  ? "bg-[#A68A91]/20 p-1 rounded-md hover:translate-x-1 duration-300"
            ...
            <DropdownMenuItem
              ...
              className="text-[#A60321] cursor-pointer flex items-center gap-1 hover:translate-x-1 duration-300"
            >
